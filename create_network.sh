...
sleep 3
neutron subnet-create ext_net --name ext-subnet --allocation-pool start=192.168.$ID.101,end=192.168.$ID.200 --disable-dhcp --gateway 192.168.$ID.1 192.168.$ID.0/24
